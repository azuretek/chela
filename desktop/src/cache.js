...
export const CACHE_STORAGES = ['serviceworkers', 'cachestorage'];
 ...
 * @returns {string}
 */
export function buildFingerprint({ version, size, mtimeMs, commit }) {
 ...
 */
export function decideRefresh(seen, current) {
 ...
 */
export async function clear(ses, origins = []) {
  const results = [];
