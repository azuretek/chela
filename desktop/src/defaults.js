...
export const globalShortcut = 'CommandOrControl+Shift+O';
export const windowDefaults = { width: 1440, height: 920 };
export const minWindow = { width: 480, height: 400 };

export default { suggestedGateways, globalShortcut, windowDefaults, minWindow };
